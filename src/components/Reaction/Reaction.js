...
const Reaction = () => {
    ...
    return (<div className={styles.addReaction} onClick={addReactionHandler}>
               ...
               { emojiLists.map((emoji)=> <Emoji key={emoji.id} value={emoji.value} id={emoji.id} emoji={emoji.emoji} />)}
                </div>
